...
export const categories = [
  {id:'video', title:'视频作品', en:'MOTION & FILM', subtitle:'商业短片 · AI视频 · 创意实验', description:'用镜头组织叙事，让想象成为画面。', items:[
    ...
    {id:'personal-vlog', title:'【个人Vlog】关于南疆', group:'other', src:'https://github.com/linqi607/linqi607.github.io/releases/download/media-v1/personal-vlog.mp4', poster:'/assets/video-covers/personal-vlog.jpg', duration:'01:18', format:'竖屏'}
  ]},
